...
::: aside
I am passionate about science communication and enjoy translating results to non-scientists.
:::
...
Selected Posters & Talks {data-icon=book}
--------------------------------------------------------------------------------
...
```{r}
print_section(position_data, 'community_engagement')
```
